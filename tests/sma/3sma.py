...
if __name__ == "__main__":
    df = get_bars("MSFT", dt.date(2026, 1, 1), dt.date.today()+dt.timedelta(days=1), source="alpaca", interval="1m")
    profit_factor, sharpe_ratio, df_sma = three_sma_strategy(df, interval="1m")
